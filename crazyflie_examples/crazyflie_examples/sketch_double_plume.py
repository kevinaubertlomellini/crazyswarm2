...
def run_sketch(df1p, df2p, offset, lambda_value, plumes, threshold, iterations, base_file_name=None,
    ...
    configs = [
        {'drone_id': drone1_id, 'starting_position': [1.0, -0.9, 0.75]},
        {'drone_id': drone2_id, 'starting_position': [1.2, -0.9, 1.25]}
    ]
...
def main(args=None) -> None:
    plumes = [
        Plume(LatLon(35.19727,  -106.5971697), -30, 3170, 1.3),
        Plume(LatLon(35.197271, -106.597152), -35, 1200, 1.2)
    ]

    threshold = 550

    df1p = LatLon(35.197264, -106.597159)
    df2p = LatLon(35.197264, -106.597159)



    run_sketch(df1p, df2p, 0.2, 0.005, plumes, threshold, iterations=5500, base_file_name='single_plume')
