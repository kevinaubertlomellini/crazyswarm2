...
def main():
    ...
    timeHelper.sleep(TAKEOFF_DURATION + HOVER_DURATION)
    cf0.goTo([0.0,0.0,0.75],0.0, duration=5.0)
    cf1.goTo([0.0,-1.0,0.75],0.0, duration=5.0)
    cf2.goTo([1.0,0.0,0.75],0.0, duration=5.0)
    cf3.goTo([1.0,-1.0,0.75],0.0, duration=5.0)
    timeHelper.sleep(6.0)
    for i in range(100):
        cf0.velWorld([0.1,0.1,0.1],180.0)
        cf1.velWorld([0.1,0.1,0.1],180.0)
        cf2.velWorld([0.1,0.1,0.1],180.0)
        cf3.velWorld([0.1,0.1,0.1],180.0)
    ...
    cf1.land(targetHeight=0.03, duration=5.0)
    cf2.land(targetHeight=0.03, duration=5.0)
    cf3.land(targetHeight=0.03, duration=5.0)
    timeHelper.sleep(6.0)
